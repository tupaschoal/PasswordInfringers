$(function(){
    ...
    $(document).keydown(function(e){
        ...
        if (keys.toString().indexOf(konami) >= 0) {
            ...
            (function(){
                $('.site-block:first').after('<section class="site-block impossible"><a class="site-header" href="http://www.nsa.gov/">NSA</a><p class="site-status">Status: impossible</p><p class="tooltip-toggle">No Info Available</p></section>'
                    +'<section class="site-block impossible"><a class="site-header" href="http://www.gchq.gov.uk/Pages/homepage.aspx">GCHQ</a><p class="site-status">Status: impossible</p><p class="tooltip-toggle">No Info Available</p></section>');
            })();
